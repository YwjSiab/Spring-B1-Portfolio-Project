...
function displayProjects() {
    try {
        ...
        projects.forEach(project => {
            ...
            categoryElement.innerHTML = `<strong>Category:</strong> ${project.category || 'N/A'}`;
            projectCard.appendChild(categoryElement);

            // Handle missing images
            const imageElement = document.createElement('img');
            imageElement.src = project.image || 'default-placeholder.jpg';
            imageElement.alt = project.title || 'No image available';
            ...
            // Handle missing technologiesUsed
            ...
            // ✅ Ensure `technologiesUsed` is accessed correctly
            const techArray = Array.isArray(project.technologiesUsed) ? project.technologiesUsed : project.technologies;
